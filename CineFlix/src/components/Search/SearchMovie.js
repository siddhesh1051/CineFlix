...
const SearchMovie = () => {
    ...
    ChangeTitleFunction("Search Movies | Cineflix")
    ...
    const getData = async () => {
        const res = await axios.get(`https://api.themoviedb.org/3/search/movie?api_key=4e44d9029b1270a757cddc766a1bcb63&language=en-US&query=${searchText}&page=${Page}&include_adult=false`)
            ...
            <div className="search__bar__div w-full text-center">
                ...
                <div className="text-center flex w-full justify-center mt-5 mb-9">
                    ...
                    <div className="md:w-[70%] w-[100%] text-center px-5 py-4 flex items-center bg-[#292929] rounded-2xl justify-center drop-shadow-2xl" >
                        ...
                        <input type="text" className="SearchBar text-xl bg-[#292929] text-slate-300 w-[60%] flex-1 duration-500 outline-none focus:outline-none placeholder:text-[#454F51]" placeholder="Enter Movie Name" value={searchText} onChange={handleOnChange1} />
