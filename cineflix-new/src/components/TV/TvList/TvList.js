...
const MovieList = () => {
    ...
    const getData = async () => {
        const res = await axios.get(`https://api.themoviedb.org/3/tv/${type ? type : "now_playing"}?api_key=4e44d9029b1270a757cddc766a1bcb63&language=en-US&page=${Page}`)
        ...
        <div className="movie__list">
            ...
            {Loading && type
                ...
                <>
                    ...
                    </div><div className="btn__div text-center m-4 p-4 text-[#ff505b] text-xl">
